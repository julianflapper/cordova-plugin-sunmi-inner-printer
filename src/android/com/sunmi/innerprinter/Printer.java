...
public class Printer extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
		if (action.equals("printerInit")) {
			...
			printerInit(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
			...
			Semaphore s = new Semaphore(0);
			printerSelfChecking(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			getPrinterSerialNo(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			getPrinterVersion(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			hasPrinter(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			getPrintedLength(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			lineWrap(data.getInt(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			sendRAWData(data.getString(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			setAlignment(data.getInt(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			setFontName(data.getString(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			setFontSize((float) data.getDouble(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printTextWithFont(data.getString(0), data.getString(1), (float) data.getDouble(2), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printColumnsText(data.getJSONArray(0), data.getJSONArray(1), data.getJSONArray(2), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printBitmap(data.getString(0), data.getInt(1), data.getInt(2), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printBarCode(data.getString(0), data.getInt(1), data.getInt(2), data.getInt(1), data.getInt(2), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printQRCode(data.getString(0), data.getInt(1), data.getInt(2), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printOriginalText(data.getString(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printString(data.getString(0), new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			Semaphore s = new Semaphore(0);
			printerStatusStartListener(new CallbackContext(callbackContext.getCallbackId(), webView) {
				@Override
				public void success(String string) {
					s.release();
				}
			...
			enterPrinterBuffer(data.getBoolean(1));
			return true;
		} else if (action.equals("exitPrinterBuffer")) {
			exitPrinterBuffer(data.getBoolean(1));
			return true;
		}
